...
\usepackage{geometry}                   % Flexible Einstellung der Seitenränder
...
\usepackage{tabularx}                   % Tabellen mit automatisch angepasster Spaltenbreite

\usepackage{booktabs}                   % Professionelle horizontale Linien in Tabellen

\usepackage{multirow, multicol}         % Zellen über mehrere Zeilen bzw. Spalten
...
\usepackage[backend=biber,]{biblatex}   % Paket zur erzeugung von Literaturverzeichnissen | Einfach Quellen in literatur.bib machen
...
\usepackage[noabbrev]{cleveref}         % Intelligente Querverweise (Abb., Gl., Tab. automatisch)